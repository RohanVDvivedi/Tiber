...
PUBLIC_HEADERS:=${PROJECT_NAME}.h tiber_io.h tiber_stream_for_file_descriptor.h tiber_channel.h tiber_cond_utils.h
...
LFLAGS:=-L${LIB_DIR} -l${PROJECT_NAME} -lconnman -lboompar -lcutlery
# Archiver
AR:=ar rcs
